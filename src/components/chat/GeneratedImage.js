        ...
        >
          <div className="flex relative w-fit">
            ...
            <button
              ...
              className="absolute m-[10px] bottom-0 right-0 inline-flex items-center gap-1 px-2 py-1 bg-gray-50 text-gray-600 rounded-full hover:bg-gray-100 transition-colors cursor-pointer"
            >
