            ...
            <section id="introduction" className="space-y-4">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-blue-800 text-sm">
                  <strong>Our Commitment:</strong> We prioritize your privacy
                  and implement industry-standard security measures to protect
                  your personal information and maintain your trust.
                </p>
              </div>
            </section>
            ...
            <section id="information-collection" className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>
                    <strong>Account Data:</strong> User ID, authentication
                    tokens, account preferences
                  </li>
                  <li>
                    <strong>Communication Data:</strong> Chat messages,
                    conversation history, AI interactions
                  </li>
                  <li>
                    <strong>Usage Data:</strong> Feature usage patterns, session
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>
                    <strong>Connection Data:</strong> IP address, location data
                    (general geographic region)
                  </li>
                  <li>
                    <strong>Performance Data:</strong> Error logs, response
                    times, system performance metrics
                  </li>
                </ul>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>
                    <strong>Feedback:</strong> User feedback, ratings, and
                    support communications
                  </li>
                  <li>
                    <strong>User-Generated Content:</strong> Any content you
                    create or share through our platform
                  </li>
                </ul>
              </div>
            </section>
            ...
            <section id="data-usage" className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>
                    <strong>Integration:</strong> Connect with your authorized
                    third-party services (Google Workspace)
                  </li>
                  <li>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>
                    <strong>AI Training:</strong> Improve AI responses and
                    accuracy (using anonymized data only)
                  </li>
                  <li>
            ...
            <section id="data-storage" className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>
                    <strong>Secure Infrastructure:</strong> Use of secure cloud
            ...
            <section id="third-party-services" className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>
                    <strong>Other OAuth Providers:</strong> Additional
                    authentication options may be available
                  </li>
                </ul>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>
                    <strong>Speech Services:</strong> Voice-to-text and
                    text-to-speech processing
                  </li>
                  <li>
                    <strong>Search APIs:</strong> Web search and content
                    extraction services
                  </li>
                </ul>
            ...
            <section id="google-integration" className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>
                    <strong>Google Drive:</strong> Access and search files,
                    create documents (with your permission)
                  </li>
                  <li>
                    <strong>Google Docs/Sheets/Slides:</strong> Create, read,
                    and edit documents as requested
                  </li>
                  <li>
                    <strong>Google Calendar:</strong> Read events and create
                    calendar entries when requested
                  </li>
                  <li>
                    <strong>Google Forms:</strong> Create forms and access
                    responses as needed
                  </li>
                </ul>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>
                    <strong>Session-Based Access:</strong> Data is accessed only
                    when you make specific requests
                  </li>
                  <li>
                    <strong>Minimal Processing:</strong> We process only the
                    minimum data necessary to fulfill your request
                  </li>
                  <li>
                    <strong>No Background Access:</strong> We do not access your
                    Google data when you're not actively using the service
                  </li>
                </ul>
            ...
            <section id="voice-data" className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>
                    <strong>No Recording:</strong> We do not record, store, or
                    save your voice input
                  </li>
                  <li>
                    <strong>Immediate Deletion:</strong> Audio data is discarded
                    immediately after processing
                  </li>
                  <li>
                    <strong>Secure Transmission:</strong> All voice data is
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>
                    <strong>Streaming:</strong> Audio is streamed directly to
                    your device without storage
                  </li>
                  <li>
                    <strong>No Retention:</strong> Generated audio is not stored
                    or retained
                  </li>
                </ul>
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  <p className="text-green-800 text-sm">
                    <strong>Privacy Guarantee:</strong> Your voice is never
                    recorded, stored, or used for any purpose other than
                    immediate conversion to text for your current conversation.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section id="shared-content" className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>
                    <strong>Public Access:</strong> Shared content becomes
                    publicly accessible via unique URLs
                  </li>
                  <li>
                    <strong>Attribution:</strong> Your name is associated with
                    the shared content
                  </li>
                  <li>
                    <strong>View Tracking:</strong> We track basic view
                    statistics for shared content
                  </li>
                  <li>
                    <strong>Automatic Expiration:</strong> Shared content
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>
                    <strong>Removal Rights:</strong> You can request removal of
                    shared content at any time
                  </li>
                  <li>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  <p className="text-yellow-800 text-sm">
                    <strong>Caution:</strong> Only share content that you're
                    comfortable making public. Avoid sharing sensitive,
            ...
            <section id="cookies" className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>
                    <strong>Functionality:</strong> Enable core features and
                    functionality
                  </li>
                </ul>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>
                    <strong>Performance Monitoring:</strong> Monitor service
                    performance and reliability
                  </li>
                  <li>
                    <strong>Error Tracking:</strong> Identify and resolve
                    technical issues
                  </li>
                </ul>
            ...
            <section id="data-retention" className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>
                    <strong>Shared Content:</strong> Automatically deleted after
                    30 days
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Authentication Tokens:</strong> Refreshed regularly,
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>
                    <strong>Account Deletion:</strong> Complete account and data
                    deletion upon request
                  </li>
                  <li>
                    <strong>Automatic Cleanup:</strong> Regular cleanup of
                    expired and unnecessary data
                  </li>
                </ul>
              </div>
            </section>
            ...
            <section id="user-rights" className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>
                    <strong>Data Export:</strong> Export your chat history and
                    data
                  </li>
                  <li>
                    <strong>Service Withdrawal:</strong> Discontinue service and
                    delete data
                  </li>
                  <li>
                    <strong>Third-Party Revocation:</strong> Revoke access to
                    integrated services
                  </li>
                </ul>
            ...
            <section id="children-privacy" className="space-y-4">
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                <p className="text-red-800 text-sm">
                  <strong>Age Requirement:</strong> Users must be at least 13
                  years old to use QuestWhisper. Users under 18 should have
                  parental consent.
                </p>
              </div>
            </section>
            ...
            <section id="international-transfers" className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  ...
                  <li>
                    <strong>Contractual Safeguards:</strong> Standard
                    contractual clauses for international transfers
                  </li>
                  <li>
                    <strong>Security Measures:</strong> Consistent security
                    standards across all locations
                  </li>
                  <li>
                    <strong>Compliance:</strong> Adherence to international data
